    ...
    <section ref={heroRef} className="relative px-4 py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className={`my-12 transition-all duration-700 delay-900 ${
            heroVisible ? 'animate-fade-in' : 'opacity-0 translate-y-4'
          }`}>
            <div className="bg-discord-blurple/10 backdrop-blur-sm border border-discord-blurple/20 rounded-xl p-8 max-w-xl mx-auto text-center">
              <div className="flex items-center justify-center gap-2 mb-4">
                <svg className="h-6 w-6 text-discord-blurple" viewBox="0 0 24 24" fill="currentColor">
                ...
                <p className="text-base font-semibold text-discord-blurple">
              ...
              <div className="flex justify-center">
                <DiscordLoginButton 
                  ...
                  className="bg-discord-blurple hover:bg-discord-blurple-hover text-white px-8"
                />
              </div>
            </div>
          </div>
          ...
          <div className={`flex flex-col items-center gap-8 transition-all duration-700 delay-1000 ${
            ...
            <p className="text-sm text-muted-foreground font-medium">
              Trusted by 12,847 YouTube creators and agencies worldwide
            </p>
