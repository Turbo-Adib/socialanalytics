    ...
    <div className="bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-3">
          <h3 className="text-sm font-semibold text-blue-900 dark:text-blue-100">Data Sources & Methodology</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800 dark:text-blue-200">
            <div className="space-y-2">
              ...
              <ul className="space-y-1 ml-6 text-blue-700 dark:text-blue-300">
          ...
          <div className="bg-blue-100 dark:bg-blue-900/50 rounded p-3">
            <div className="flex items-start gap-2">
              <AlertTriangle className="h-4 w-4 text-blue-700 dark:text-blue-300 mt-0.5 flex-shrink-0" />
